...
const getAllCars = () => {
    axios.get(baseUri + baseUrl)
        ...
        .catch(error => {
            console.error(error);
            var outText = '<div class="row"> <h2>No Data Available</h2> </div>';
            var total = 100;
            var inCount = 0;
            var outCount = 0;
            ...
            var dailyPer = (inCount + outCount) / (diffDays);
            dailyPer = dailyPer.toFixed(1);
            document.getElementById("Daily").innerHTML = '' + dailyPer + '%';
...
function parseCarsList(carList) {
    ...
    var inCount = 0;
    var outCount = 0;
    dashboard.innerHTML += '<div class="row title"> <div class="cel"> <h3>S No</h3> </div> <div class="cel"> <h3>Name</h3> </div> <div class="cel"> <h3>Vehicle Name</h3> </div> <div class="cel"> <h3>Vehicle Number</h3> </div> <div class="cel"> <h3>Entry Date</h3> </div> <div class="cel"> <h3>Exit Date</h3> </div> <div class="cel"> <h3>Status</h3> </div> <div class="cel"> <h3>Action</h3> </div> </div>';
